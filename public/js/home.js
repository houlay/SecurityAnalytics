...
function searchStock(stock) {
    ...
    var queryURL = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=" + stockN + "&apikey=2VR5U55WNY713BO3";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (value) {
...
function searchCryptocurrency(cryptocurrency) {
    ...
    var queryURL = "https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=" + cryptoN + "&market=USD&apikey=2VR5U55WNY713BO3";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (value) {
